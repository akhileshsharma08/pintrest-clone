...
const Header = () => {
  ...
  return (
    <>
      <nav className={`sticky top-0 left-0 z-10 flex justify-between md:px-8 px-4 items-center bg-white py-4 `}>
        ...
        >
          ...
          <option className="pr-2" value="/">home </option>
        ...
        <ul className="hidden md:flex justify-between items-center gap-3 capitalize">
          <Link href="/today">
            <li className={`navlink hover:bg-black hover:text-white rounded-full px-3 py-1 ${pathname === "/today" ? "active bg-black  text-white" : ""}`}>
              Today
            </li>
          </Link>
          <Link href="/watch">
            <li className={`navlink hover:bg-black hover:text-white rounded-full px-3 py-1 ${pathname === "/watch" ? "active bg-black  text-white" : ""}`}>
              Watch
            </li>
          </Link>
          <Link href="/explore">
            <li className={`navlink hover:bg-black hover:text-white rounded-full px-3 py-1  ${pathname === "/explore" ? "active bg-black  text-white" : ""}`}>
              Explore
            </li>
          </Link>
          ...
          <Link href="/about">
            <li className={`navlink hover:bg-black hover:text-white rounded-full px-3 py-1 ${pathname === "/about" ? "active bg-black  text-white" : ""}`}>
              About
            </li>
          </Link>
          <Link href="/business">
            <li className={`navlink hover:bg-black hover:text-white rounded-full px-3 py-1 ${pathname === "/business" ? "active bg-black  text-white" : ""}`}>
              Business
            </li>
          </Link>
          <Link href="/">
            <li className={`navlink hover:bg-black hover:text-white rounded-full px-3 py-1 ${pathname === "/press" ? "active bg-black  text-white" : ""}`}>
              Press
            </li>
          </Link>
        </ul>
